...
/* bin/.libs/lt-pa_devs.c - temporary wrapper executable for .libs/pa_devs
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1

   The bin/pa_devs program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "pa_devs"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"pa_devs:bin/pa_devs:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pa_devs:bin/pa_devs:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
