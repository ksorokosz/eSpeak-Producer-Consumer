...
/* bin/.libs/lt-patest_sine_formats.c - temporary wrapper executable for .libs/patest_sine_formats
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1

   The bin/patest_sine_formats program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "patest_sine_formats"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bin/patest_sine_formats - temporary wrapper script for .libs/patest_sine_formats\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The bin/patest_sine_formats program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"patest_sine_formats:bin/patest_sine_formats:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"patest_sine_formats:bin/patest_sine_formats:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"patest_sine_formats:bin/patest_sine_formats:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
