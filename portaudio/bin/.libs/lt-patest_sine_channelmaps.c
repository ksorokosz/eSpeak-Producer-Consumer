...
/* bin/.libs/lt-patest_sine_channelmaps.c - temporary wrapper executable for .libs/patest_sine_channelmaps
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1

   The bin/patest_sine_channelmaps program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "d:\\Programowanie\\Nauka\\eSpeak-Sample\\portaudio\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d:\\Programowanie\\Nauka\\eSpeak-Sample\\portaudio\\lib\\.libs;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "patest_sine_channelmaps"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bin/patest_sine_channelmaps - temporary wrapper script for .libs/patest_sine_channelmaps\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The bin/patest_sine_channelmaps program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"patest_sine_channelmaps:bin/patest_sine_channelmaps:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"patest_sine_channelmaps:bin/patest_sine_channelmaps:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"patest_sine_channelmaps:bin/patest_sine_channelmaps:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/d/Programowanie/Nauka/eSpeak-Sample/portaudio/lib/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/Programowanie/Nauka/eSpeak-Sample/portaudio/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
