...
/* bin/.libs/lt-paex_saw.c - temporary wrapper executable for .libs/paex_saw
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1

   The bin/paex_saw program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "paex_saw"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"paex_saw:bin/paex_saw:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"paex_saw:bin/paex_saw:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
