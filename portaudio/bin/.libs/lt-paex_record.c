...
/* bin/.libs/lt-paex_record.c - temporary wrapper executable for .libs/paex_record
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1

   The bin/paex_record program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "paex_record"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"paex_record:bin/paex_record:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"paex_record:bin/paex_record:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"paex_record:bin/paex_record:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
