...
/* bin/.libs/lt-patest1.c - temporary wrapper executable for .libs/patest1
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1

   The bin/patest1 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "patest1"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"patest1:bin/patest1:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"patest1:bin/patest1:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
