...
/* bin/.libs/lt-pa_minlat.c - temporary wrapper executable for .libs/pa_minlat
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2ubuntu1

   The bin/pa_minlat program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "pa_minlat"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"pa_minlat:bin/pa_minlat:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pa_minlat:bin/pa_minlat:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pa_minlat:bin/pa_minlat:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
